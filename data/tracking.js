...
function renderTrackingHTML() {
    ...
    deliveryDateHTML.innerHTML = `Arriving on ${deliveryEstimate.format('dddd, MMMM DD')}`
    ...
    if (progressPercent < 0) progressPercent = 0; if (progressPercent > 100) progressPercent = 100;
